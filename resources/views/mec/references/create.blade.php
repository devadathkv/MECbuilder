...
@section('content')
    <div class="container mx-auto mt-8 max-w-lg bg-gray-900 text-white rounded-2xl shadow-lg p-6">
        <h2 class="text-2xl font-bold mb-4 text-center text-blue-400">Edit Reference</h2>
        ...
        <form action="{{ route('references.update', $reference->id) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="institution" id="institution"
                    class="w-full bg-gray-800 text-gray-200 border border-gray-700 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    value="{{ old('institution', $reference->institution) }}">
            </div>
