        ...
        <form action="<?php echo e(route('education.store')); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="degree" id="degree" class="form-control"
                    placeholder="Enter degree or course" required>
            </div>

            <div class="mb-3">
                <label for="year" class="form-label">Year of Completion</label>
                <input type="number" name="year" id="year" class="form-control" min="1900"
                    max="<?php echo e(now()->year); ?>" placeholder="e.g., 2025" required>
            </div>

            <div class="mb-3">
                <label for="grade" class="form-label">Grade/Percentage</label>
                <input type="text" name="grade" id="grade" class="form-control" placeholder="e.g., 85% or 8.5 CGPA"
                    required>
            </div>
