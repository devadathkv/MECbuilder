...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-cta">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="cta-btn secondary">Get Started</a>
                </div>
            </div>
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <a href="<?php echo e(route('register')); ?>" class="cta-btn primary large">Create My Resume Now</a>
        </div>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\resume_builder\resources\views\home.blade.php ENDPATH**/ ?>